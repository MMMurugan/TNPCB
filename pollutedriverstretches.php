                ...
                <div class=" bg-dark-overlay-4 overflow-hidden card-bg-scale h-200 text-center"
                    ...
                    <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                        <div class="w-100 my-auto">
                            <h1 class="text-white display-4">POLLUTED RIVER STRETCHES</h1>
                            <!-- breadcrumb -->
                            <nav class="d-flex justify-content-center" aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
                                    <li class="breadcrumb-item"><a href="index.html"><i
                                                class="bi bi-house me-1"></i> Home</a></li>
                                    <li class="breadcrumb-item active">POLLUTED RIVER STRETCHES</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-9 mx-auto">
                <h2 class="mb-3 sec_title mb-4 text-center">POLLUTED RIVER STRETCHES</h2>

                <p class="lead mt-4" style="text-align: center;">
                    Site Working on Updates. Please Check Back Later.
                </p>
